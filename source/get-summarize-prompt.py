...
<USER>
I will now provide the project structure and the content of all relevant files. Adhere strictly to all rules defined in the system prompt, especially the workflow protocol and output formatting. Prepare to receive context.</USER>"""
